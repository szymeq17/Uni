...
(time (falsifiable-cnf? (make-conj (make-conj (make-conj (make-conj (make-conj 'i 'j) (make-conj'e 'f)) (make-conj 'a 'b)) (make-conj'p 'q)) (make-conj (make-conj (make-conj (make-conj 'k 'l) (make-conj 'g 'h)) (make-conj (make-conj 'm 'n) (make-conj 'p 'q))) (make-conj 'c 'd)))))

(time (falsifiable-eval? (make-conj (make-conj (make-conj (make-conj (make-conj 'i 'j) (make-conj'e 'f)) (make-conj 'a 'b)) (make-conj'p 'q)) (make-conj (make-conj (make-conj (make-conj 'k 'l) (make-conj 'g 'h)) (make-conj (make-conj 'm 'n) (make-conj 'p 'q))) (make-conj 'c 'd)))))
"falsifiable-cnf?"
(time (falsifiable-cnf? (make-disj (make-disj (make-disj (make-disj (make-disj 'i 'j) (make-disj'e 'f)) (make-disj 'a 'b)) (make-disj'p 'q)) (make-disj (make-disj (make-disj (make-disj 'k 'l) (make-disj 'g 'h)) (make-disj (make-disj 'm 'n) (make-disj 'p 'q))) (make-disj 'c 'd)))))
"falsifiable-eval?"
(time (falsifiable-eval? (make-disj (make-disj (make-disj (make-disj (make-disj 'i 'j) (make-disj'e 'f)) (make-disj 'a 'b)) (make-disj'p 'q)) (make-disj (make-disj (make-disj (make-disj 'k 'l) (make-disj 'g 'h)) (make-disj (make-disj 'm 'n) (make-disj 'p 'q))) (make-disj 'c 'd)))))